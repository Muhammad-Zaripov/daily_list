class AppAssets {
  ...
  static const String actionCheckboxFilled =
      "${_baseIcon}action-checkbox-filled.svg";
  static const String option = "${_baseIcon}option.svg";
  static const String notificationOutline =
      "${_baseIcon}notification_outline.svg";
  ...
  static const String delete = "${_baseImage}delete.png";
  static const String notification =
      "${_baseImage}action-notification-filled.png";
}
