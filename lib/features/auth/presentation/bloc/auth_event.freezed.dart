...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email,  String password)?  login,TResult Function( String email,  String password,  String? name)?  register,TResult Function()?  logout,TResult Function()?  checkAuthStatus,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Login() when login != null:
return login(_that.email,_that.password);case _Register() when register != null:
return register(_that.email,_that.password,_that.name);case _Logout() when logout != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email,  String password)  login,required TResult Function( String email,  String password,  String? name)  register,required TResult Function()  logout,required TResult Function()  checkAuthStatus,}) {final _that = this;
switch (_that) {
case _Login():
return login(_that.email,_that.password);case _Register():
return register(_that.email,_that.password,_that.name);case _Logout():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email,  String password)?  login,TResult? Function( String email,  String password,  String? name)?  register,TResult? Function()?  logout,TResult? Function()?  checkAuthStatus,}) {final _that = this;
switch (_that) {
case _Login() when login != null:
return login(_that.email,_that.password);case _Register() when register != null:
return register(_that.email,_that.password,_that.name);case _Logout() when logout != null:
...
class _Register implements AuthEvent {
  const _Register({required this.email, required this.password, this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Register&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.name, name) || other.name == name));
}
